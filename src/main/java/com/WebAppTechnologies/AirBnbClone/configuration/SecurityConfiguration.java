package com.WebAppTechnologies.AirBnbClone.configuration;
...
import com.WebAppTechnologies.AirBnbClone.utils.RSAKeyProperties;
...
//                    auth.requestMatchers("/user/recommended_rentals").hasRole("TENANT");
                    auth.requestMatchers("/user/recommended_rentals").permitAll();
